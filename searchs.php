...
$keyword = $_GET["keyword"]; // ambil keyword
   ...
   $x++;
	...
	// tampilkan kotak pencarian dan jumlah hasil pencarian
	  ...
	  echo "<br /><br><table><tr><td></td><td><form action='searchs.php' method='GET'><br><input type='text' onclick=value='' size='50' name='keyword' value='$keyword' style='width: 500px; height: 30px; font-size: 16px;'>  <input type='submit' value='Cari'></form></td></tr></table>";
